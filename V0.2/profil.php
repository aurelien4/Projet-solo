...
<div class="container"> <?php
	...
	<div class="row">
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="row">
							<div class="col-md-offset-1 col-md-2"><h5>Email:<?php echo $donnee['email']; ?></h5></div>
							<div class="col-md-offset-4 col-md-3"><h5>Pseudo:<?php echo $donnee['pseudo']; ?></h5></div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				if(isset($_SESSION['pseudo'])){
						$dataCom = $dbh->prepare('SELECT count(*) AS NbCom FROM commentaires WHERE pseudo = ?');
